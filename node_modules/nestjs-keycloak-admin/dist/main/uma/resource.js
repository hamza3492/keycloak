...
class Resource {
    constructor(resource, scopes) {
        ...
        this.owner = (_a = resource.owner) === null || _a === void 0 ? void 0 : _a.id;
        this.ownerManagedAccess = resource.ownerManagedAccess || false;
        this.attributes = resource.attributes;
        if (resource.resource_scopes) {
            this.setResourceScopes(resource.resource_scopes.map((s) => new scope_1.Scope(s)));
        }
        if (scopes) {
            this.setScopes(scopes.map((s) => new scope_1.Scope(s)));
        }
    }
    setId(id) {
        this.id = id;
